  ...
  test: {
    ...
    coverage: {
      ...
      thresholds: {
        ...
        branches: 25,
        statements: 28,
        "js/app/{typeahead,streamGate,diffParse,fuzzy,patchBuilder,rpc,fileTypes,flowControl,pasteFiles,store,csv,terminalSend,pastedFileUpload,touchScroll,touchKeys,sizeRole,deviceId,reorder,composerSize}.ts":
          {
            lines: 90,
            functions: 85,
            branches: 70,
