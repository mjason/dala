    ...
    >
      ...
      <div className="mt-1 flex items-center gap-2">
        <button
          ...
          onClick={send}
          disabled={!value.trim()}
          className="inline-flex shrink-0 items-center gap-1.5 rounded-md bg-mint px-2.5 py-1 text-[12px] font-medium text-bg0 transition-all hover:brightness-110 active:scale-[0.98] disabled:opacity-40 pointer-coarse:min-h-10 pointer-coarse:px-4 pointer-coarse:text-sm"
        >
          {t("inputBarSend")}{" "}
