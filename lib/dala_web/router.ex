defmodule DalaWeb.Router do
  ...
  scope "/", DalaWeb do
    ...
    ash_authentication_live_session :authenticated_routes do
      ...
      # on_mount {DalaWeb.LiveUserAuth, :live_user_required}
      #
      # If an authenticated user *may* be present:
      # on_mount {DalaWeb.LiveUserAuth, :live_user_optional}
      #
  ...
  scope "/", DalaWeb do
    ...
    confirm_route Dala.Accounts.User, :confirm_new_user,
      auth_routes_prefix: "/auth",
      overrides: [DalaWeb.AuthOverrides, Elixir.AshAuthentication.Phoenix.Overrides.Default]

    # Remove this if you do not use the magic link strategy.
    magic_sign_in_route(Dala.Accounts.User, :magic_link,
      auth_routes_prefix: "/auth",
      overrides: [DalaWeb.AuthOverrides, Elixir.AshAuthentication.Phoenix.Overrides.Default]
    )
  end
