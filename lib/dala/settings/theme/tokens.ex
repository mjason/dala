defmodule Dala.Settings.Theme.Tokens do
  @moduledoc """
  The canonical custom-theme token contract: the 46 colour slots a theme may
  ...
  spellings. Adding or renaming a token means changing BOTH sides. The 46
  keys, grouped:

    * UI shell (8):   bg0 bg1 bg2 line fg fgMuted mint danger
    * Git states (7): gitAdded gitModified gitDeleted gitRenamed gitUntracked
                      gitConflict gitIgnored
  ...
  @token_keys ~w(
    ...
    gitAdded gitModified gitDeleted gitRenamed gitUntracked gitConflict gitIgnored
  ...
  @doc "The 46 canonical token keys (strings, camelCase)."
  def token_keys, do: @token_keys

  @doc "How many canonical tokens there are (46)."
  ...
  Returns `{:ok, clean}` when every key is one of the 46 canonical tokens and
