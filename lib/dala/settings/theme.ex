defmodule Dala.Settings.Theme do
  ...
  46-key contract and the write-time whitelist. Six `builtin` presets ship as
  ...
  attributes do
    ...
    attribute :tokens, :map do
      description "Sparse colour overrides — see Dala.Settings.Theme.Tokens for the 46-key contract."
      public? true
      allow_nil? false
    end
